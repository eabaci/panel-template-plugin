...
export declare const toUtc: (input?: string | number | Date | (string | number)[] | DateTime | undefined, formatInput?: FormatInput) => DateTime;
export declare const toDuration: (input?: string | number | DateTimeDuration | undefined, unit?: "s" | "m" | "h" | "d" | "year" | "years" | "y" | "month" | "months" | "M" | "week" | "weeks" | "w" | "day" | "days" | "hour" | "hours" | "minute" | "minutes" | "second" | "seconds" | "millisecond" | "milliseconds" | "ms" | "quarter" | "quarters" | "Q" | undefined) => DateTimeDuration;
export declare const dateTime: (input?: string | number | Date | (string | number)[] | DateTime | undefined, formatInput?: FormatInput) => DateTime;
export declare const dateTimeForTimeZone: (timezone?: string | undefined, input?: string | number | Date | (string | number)[] | DateTime | undefined, formatInput?: FormatInput) => DateTime;
