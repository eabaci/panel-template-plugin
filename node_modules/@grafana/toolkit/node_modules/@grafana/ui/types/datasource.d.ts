...
import { TimeRange, RawTimeRange, TableData, TimeSeries, DataFrame, LogRowModel, LoadingState, DataFrameDTO } from '@grafana/data';
...
export declare type DataQueryResponseData = DataFrameDTO | LegacyResponseData;
