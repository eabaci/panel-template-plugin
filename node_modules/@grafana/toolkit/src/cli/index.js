...
exports.run = function (includeInternalScripts) {
    ...
    if (includeInternalScripts) {
        ...
        commander_1.default
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, execTask_1.execTask(cherrypick_1.cherryPickTask)({})];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        commander_1.default
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // @ts-ignore
                    return [4 /*yield*/, execTask_1.execTask(toolkit_build_1.toolkitBuildTask)()];
                    case 1:
                        // @ts-ignore
                        _a.sent();
                        return [2 /*return*/];
    ...
    commander_1.default
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, execTask_1.execTask(plugin_build_1.pluginBuildTask)({ coverage: false })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
