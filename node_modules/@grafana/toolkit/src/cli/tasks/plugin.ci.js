...
var buildPluginRunner = function (_a) {
    ...
    return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var start, workDir, file_1, _b, _c, name_1, dir;
        var e_1, _d;
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    fs_1.default.mkdirSync(path.resolve(process.cwd(), 'dist'));
                    file_1 = path.resolve(process.cwd(), 'dist', "README_" + backend + ".txt");
                    fs_1.default.writeFile(file_1, "TODO... build bakend plugin: " + backend + "!", function (err) {
                        if (err) {
                            throw new Error('Unable to write: ' + file_1);
                        }
                    });
                    return [3 /*break*/, 4];
                case 2: 
 ...
 *
 */
var buildPluginDocsRunner = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
 ...
 */
var packagePluginRunner = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
