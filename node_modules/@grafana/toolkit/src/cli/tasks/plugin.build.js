...
exports.bundlePlugin = useSpinner_1.useSpinner('Compiling...', function (options) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
    switch (_a.label) {
...
exports.prepare = useSpinner_1.useSpinner('Preparing', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
// @ts-ignore
var typecheckPlugin = useSpinner_1.useSpinner('Typechecking', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
                    ...
                    promises = sources.map(function (s, i) {
                        return new Promise(function (resolve, reject) {
                            fs_1.default.readFile(s, function (err, data) {
                                ...
                                var opts = tslib_1.__assign({}, prettierConfig, { filepath: s });
        ...
        return tslib_1.__generator(this, function (_b) {
            ...
            if (lintResults.length > 0) {
                ...
                failures.forEach(function (f) {
                    ...
                    console.log((f.getRuleSeverity() === 'warning' ? 'WARNING' : 'ERROR') + ": " + f.getFileName().split('src')[1] + "[" + f.getStartPosition().getLineAndCharacter().line + ":" + f.getStartPosition().getLineAndCharacter().character + "]: " + f.getFailure());
                });
                console.log('\n');
