...
var escapeRegExp_1 = tslib_1.__importDefault(require("lodash/escapeRegExp"));
var path = require('path');
var distDir, cwd;
// @ts-ignore
exports.clean = useSpinner_1.useSpinner('Cleaning', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
    switch (_a.label) {
...
// @ts-ignore
var compile = useSpinner_1.useSpinner('Compiling sources', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var e_1;
...
var preparePackage = function (pkg) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pkg.bin = {
...
var copyFiles = function () {
    ...
    // @ts-ignore
    return useSpinner_1.useSpinner("Moving " + files.join(', ') + " files", function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var promises;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
var copySassFiles = function () {
    ...
    // @ts-ignore
    return useSpinner_1.useSpinner("Copy scss files " + files.join(', ') + " files", function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
var toolkitBuildTaskRunner = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var pkg, index;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 5:
                ...
                index = distDir + "/src/index.js";
                fs.readFile(index, 'utf8', function (err, data) {
                    var pattern = 'require("./';
                    var js = data.replace(new RegExp(escapeRegExp_1.default(pattern), 'g'), 'require("./src/');
                    fs.writeFile(distDir + "/index.js", js, function (err) {
                        if (err) {
