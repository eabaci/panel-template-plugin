...
var S3Client = /** @class */ (function () {
    ...
    S3Client.prototype.writeJSON = function (key, obj, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.s3.putObject(tslib_1.__assign({}, params, { Key: _this.prefix + key, Bucket: _this.bucket, Body: JSON.stringify(obj, null, 2), ContentType: 'application/json' }), function (err, data) {
                            if (err) {
                                reject(err);
                            }
                            else {
